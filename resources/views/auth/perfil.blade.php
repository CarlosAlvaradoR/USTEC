                                ...
                                <form class="space-y-3 p-2" action="{{ route('perfil.change') }}" method="POST">
                                    ...
                                    <div>
                                        ...
                                        <x-input id="password_actual" class="block mt-1 w-full" type="password"
                                            name="password_actual" placeholder="Ingrese su contraseña actual" value=""
                                            required autofocus />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <x-input id="password" class="block mt-1 w-full" type="password" name="password"
                                            placeholder="Ingrese Nueva Contraseña" value="" required autofocus />
                                    </div>
                                    ...
                                    <div>
                                        <x-label for="password_confirmation"
                                            :value="__('Confirmar Contraseña Nueva')" />

                                        <x-input id="password_confirmation" class="block mt-1 w-full" type="password"
                                            name="password_confirmation" placeholder="Repita la contraseña" value=""
                                            required autofocus />
                                    </div>
                                    <div class="flex justify-center">
